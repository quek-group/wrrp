...
!    integer, allocatable :: r2real ! (3,nr) - temp. holder for rvec2real
  ...
  ! Nic modifications, refer to main program for documentation
...
!    allocate(r2real (3,nr), STAT=allocerr)
    ...
    ! Nic: all supercell stuff done here
    call get_sc_grid(a,nfft,rcart,sc_size,sc_a,sc2uc_idx,scvec2real,sc_rcart)

!!!!!LOG
    write(85,*) repeat("=",79)
    !write(85,*) "----------------------------------------------"
    write(85,*) "The real space grid deltas in alat are:"
    write(85,905) (dela1(i),i=1,3)
    write(85,905) (dela2(i),i=1,3)
    write(85,905) (dela3(i),i=1,3)
    write(85,*) repeat("=",79)
    !write(85,*) "----------------------------------------------"
