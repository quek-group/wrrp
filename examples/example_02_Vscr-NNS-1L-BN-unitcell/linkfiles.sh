...
ln -s ./1-scf/$PREFIX.save/charge-density.hdf5   ./3-wfn_nns/$PREFIX.save
ln -s ./1-scf/$PREFIX.save/data-file-schema.xml  ./3-wfn_nns/$PREFIX.save

# link WFN files to EPSILON / SIGMA directories
ln -s ./2-wfn/wfn.cplx      ./4-epsilon/WFN
ln -s ./2-wfn/wfn.cplx      ./5-epsilon_qmap/WFN

ln -s ./3-wfn_nns/wfn.cplx  ./4-epsilon/WFNq
ln -s ./3-wfn_nns/wfn.cplx  ./5-epsilon_qmap/WFNq
...
# link files for WRRP
ln -s ./2-wfn/subweights.dat   ./7-wrrp/subweights.dat
